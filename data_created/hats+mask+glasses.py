print("ashish kumar")
# Combination hat + mask + sunglasses
import os
import numpy as np
...
output_full = 'output/hat_mask_glass'
...
def place_all(image_path, hat_name, glass_name, mask_name, index):
    ...
    face_img.convert('RGB').save(os.path.join(output_full, filename))
...
for i, file in enumerate(input_files):
    ...
    place_all(img_path, hat_name, glass_name, mask_name, i)

print("All hat + mask + sunglasses images done.")
